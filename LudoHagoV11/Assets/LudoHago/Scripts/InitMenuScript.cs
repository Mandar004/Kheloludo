...
public class InitMenuScript : MonoBehaviour
{
    ...
    public void ShowGameConfiguration(int index)
    {
        switch (index)
        {
            ...
            case 3:
                GameManager.Instance.type = MyGameType.Bid;
                GameConfigurationScreenBid.SetActive(true);
                break;
        }
    ...
    public void ShowGameConfigurationVSComputer(int index)
    {
        switch (index)
        {
            case 0:
                GameManager.Instance.type = MyGameType.Computer;
                GameConfigurationScreenvsComputer.SetActive(true);
    ...
    public void changeUserName()
    {
        ...
        {
            GameManager.Instance.playfabManager.addCoinsRequest(0);
