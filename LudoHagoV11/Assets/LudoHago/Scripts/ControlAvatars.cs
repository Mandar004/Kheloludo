...
public class ControlAvatars : MonoBehaviour
{
    ...
    public void reset()
    {
        ...
        else
        {
            ...
            {
                Debug.Log("Timeout 0.0s");
               // PhotonNetwork.BackgroundTimeout = 0.2f;
            }
            else
            {
        ...
        if (GameManager.Instance.type == MyGameType.TwoPlayer || GameManager.Instance.type == MyGameType.Computer)
        {
...
public void ShareCoderefcode()
    {
        ...
        string shareText = StaticStrings.SharePrivateLinkMessage1 + " "  + "\n\n" + GameManager.Instance.refcode + " ";
#if UNITY_ANDROID
        shareText += "https://hogotickmadeinindialudo.online/";
#elif UNITY_IOS
        shareText += "https://hogotickmadeinindialudo.online/" + StaticStrings.ITunesAppID;
#endif
    ...
    public void OpenWhatsAppHelp()
    {
        ...
        Application.OpenURL(StaticStrings.Whatsapphelp);
